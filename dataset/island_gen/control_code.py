...
def evaluate_design(ind_num):
    ...
    genome_name = 'temp_island_individual'
...
if __name__ == '__main__':
    ...
    path_CSV = os.path.join(os.path.dirname(path_current),'CSV_island')
    ...
    if int(group) in groups:
        ind1, ind2 = (int(group)-1)*2500+1, int(group)*2500
    else:
