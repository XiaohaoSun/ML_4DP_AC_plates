...
def evaluate_design(ind_num):
    ...
    genome_name = 'temp_hrch3x3_individual'
...
if __name__ == '__main__':
    ...
    path_CSV = os.path.join(os.path.dirname(path_current),'CSV_hrch3x3')
    ...
    groups = [1,2] # contain (okay to have more than) actual group numbers
    
    if int(group) in groups:
        ind1, ind2 = (int(group)-1)*500+1, int(group)*500
        # ind1, ind2 = 8, 9
    else:
