function [outx,outy,outz,inBinary] = data_convertBC2(outx,outy,outz,inBinary)
...
% 3, x-axis rotate, D to xy-plane(i.e., z=0, same level with B)
...
% 3
% now AB is x-axis, project BD on yz-plane to find the angle, then x-axis rotate
gamma = -atan2d(outz(end,1,:,:),outy(end,1,:,:));
