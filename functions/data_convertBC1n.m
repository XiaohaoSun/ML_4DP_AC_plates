function [outx,outy,outz] = data_convertBC1n(outx,outy,outz,n)
% [outx,outy,outz] = data_convertBC1n(outx,outy,outz,n), 
% use n=2 by default.
...
% 1
gamma = -atan2d(outy(n,n,:,:),outx(n,n,:,:));
...
% 2
gamma = atan2d(outz(n,n,:,:),outx(n,n,:,:));
...
gamma = -atan2d(outz(n,1,:,:)-outz(1,n,:,:),outy(n,1,:,:)-outy(1,n,:,:));
